...
export const tableMockData = [
    ...
    },
    {
        ...
        platform: '1',
        promoteTarget: '提升应用安装',
        targetName: '这个是超出了两行的定向包名称，会出现省略符号,测试一下',
        targetRemark:
            '如果这是一个很长的文本，那么最多也只能存在两行，然后超出的部分用省略号显示，当鼠标悬浮到文本上时，也会显示悬浮框',
        targetScope: '通用定向',
        unitCount: 0
