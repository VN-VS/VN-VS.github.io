<template>
    <Tabs value="demo">
                    ...
                    <template slot="deliveryStatus" slot-scope="{ row }">
                        <div class="inline-row">
                            ...
                            <span class="icon-desc">{{
                                row.deliveryStatus.name
                            }}</span>
                        </div>
                    </template>
                    <!-- 关联广告组 -->
                    <template slot="unitCount" slot-scope="{ row }">
        ...
        <TabPane label="设计图" name="design">
            <img
                src="@/assets/img/stylelib/common-table-design.png"
                width="100%"/>
        </TabPane>
    </Tabs>
</template>
