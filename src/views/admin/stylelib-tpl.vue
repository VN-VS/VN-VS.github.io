<template>
    <div class="stylelib-tpl">
        <div class="opr">
            <Button type="primary" @click="createCate"> 创建模版 </Button>
            <Select
                v-model="search.keyType"
                style="width: 160px"
                @on-change="searchTpl">
                <Option
                    v-for="(i, j) in searchCate"
                    :key="j"
                    :value="i.id + ''">
                    {{ i.name }}
                </Option>
        ...
        <Modal v-model="update" title="模版" footer-hide>
            <Form
                ...
                <FormItem label="名称" prop="title">
                    <Input
                        v-model="cateValidate.title"
                        placeholder="输入模版名称"/>
                </FormItem>
                <FormItem label="分类" prop="tag_id">
                    <Select
                        v-model="cateValidate.tag_id"
                        placeholder="请选择模版分类">
                        <Option
                            v-for="(i, j) in cate"
                            :key="j"
                ...
                <FormItem label="描述" prop="desc">
                    <Input
                        v-model="cateValidate.desc"
                        placeholder="输入模版描述"/>
                </FormItem>
                <FormItem label="图片KEY" prop="cover">
                    <Input
                        v-model="cateValidate.cover"
                        placeholder="输入模版图片KEY"/>
                </FormItem>
                <FormItem label="代码仓库" prop="url">
                    <Input
                        v-model="cateValidate.url"
                        placeholder="输入模版代码仓库地址"/>
                </FormItem>
                <FormItem label="预览地址" prop="preview">
                    <Input
                        v-model="cateValidate.preview"
                        placeholder="输入模版预览地址"/>
                </FormItem>
                <FormItem>
